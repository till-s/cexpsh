...
{
	if ( sizeof(*pval) > sz ) {
			PMELF_PRINTF( pmelf_err, PMELF_PRE"pmelf_create_attribute_set(): reading beyond section (getting %s length)\n", nm);
			return -1;
	}

	memcpy(pval, b, sizeof(*pval));
			
	if ( needswap ) {
#ifdef PMELF_CONFIG_NO_SWAPSUPPORT
		PMELF_PRINTF( pmelf_err, PMELF_PRE"pmelf_create_attribute_set(): byte-swapping not configured\n");
		return -1;
#else
		elf_swap32( pval );
#endif
...
#if (defined(__PPC__) && _CALL_SYSV) || defined(DEBUG)
...
static Pmelf_attribute_vendor gnu_ppc_vendor = {
	next:	                     0,
	name:	                     "gnu",
...
static Pmelf_pub_attribute_t
pmelf_test_attribute_tag_t(Pmelf_attribute_tbl *patbl, Elf32_Word tag)
{
	switch ( tag ) {
		case  5: return Pmelf_Attribute_Type_str;
		case  4: return Pmelf_Attribute_Type_num;
		case  6: return Pmelf_Attribute_Type_num;
		case  8: return Pmelf_Attribute_Type_num;
		case 15: return Pmelf_Attribute_Type_str;
		case 16: return Pmelf_Attribute_Type_num;
		case 32: return Pmelf_Attribute_Type_both;
		case 33: return Pmelf_Attribute_Type_str;
		case 34: return Pmelf_Attribute_Type_num;
		default:
		break;
	}
	return Pmelf_Attribute_Type_unknown;
...
static const char * const
pmelf_test_attribute_tag_n(Pmelf_attribute_tbl *patbl, Elf32_Word tag)
{
	switch ( tag ) {
		case Tag_Compat: return "Tag_Compat";
		case 16:         return "i-Tag";
		case 15:         return "s-Tag";
		default:
		break;
	}
...
static Pmelf_attribute_vendor tst_vendor = {
	next:	                     0,
	name:	                     "gnu",
	file_attributes_read:        pmelf_pub_file_attributes_read,
	...
	file_attributes_print:       pmelf_pub_file_attributes_print,
	file_attribute_print:        pmelf_pub_file_attribute_print,
	max_tag:                     10
};
#endif
